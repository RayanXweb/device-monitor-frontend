...
import { 
  ...
  FiDownload, FiFilter, FiGrid, FiList, FiPlus, FiTrendingUp,
  FiTrendingDown, FiZap, FiShield, FiUsers
} from 'react-icons/fi';
  ...
  const handleBulkCommand = async (command) => {
    ...
    try {
      await Promise.all(selectedDevices.map(device => 
        sendCommand(device.deviceId, command, {})
      ));
      toast.success(`Command sent to ${selectedDevices.length} devices`);
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Quick Actions */}
        <div className="mb-8">
          <QuickActions onBulkCommand={handleBulkCommand} />
        </div>
          ...
          <div className="flex flex-wrap gap-4 items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="p-2 border dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
                    ...
                    <tr key={device.deviceId} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium">{device.cpu || 0}%</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium">{device.memory || 0}%</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
